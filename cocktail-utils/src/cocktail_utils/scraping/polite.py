...
def check_robots_allowed(base_url: str, url: str, user_agent: str = "*") -> bool:
    ...
    Example:
        >>> check_robots_allowed(
            "https://example.com", "https://example.com/page", "mybot/1.0"
        )
        True
    """
    try:
...
class PoliteSession:
    """A requests session that respects robots.txt and implements polite
    crawling delays.
    ...
    def __init__(
        ...
        Args:
            ...
            crawl_delay: Fixed crawl delay. If None, will try to read from
                         robots.txt
